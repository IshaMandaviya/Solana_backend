...
import express from "express"
import {listNFT, isMintKeyVerified, getNFTDetails,isListed,listedNFTS,fetchAllUserOwnedNfts,cancelNFTListing, FetchListedOwnedNFTsInCollection,FetchOwnedNFTsInCollection,buyNft, mintNFT} from "../controller/nfts.js"
const router = express.Router();
...
router.post("/cancelNFTListing",cancelNFTListing);
router.post("/isMintKeyVerified", isMintKeyVerified);
